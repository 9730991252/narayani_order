...
def cart(request):
    ...
    if request.session.has_key('customer_mobile'):
        ...
        if customer == None:
            ...
            total_amount_sub = total_price(customer.id)
            total_amount = (courier_charges(customer.id) + total_price(customer.id))
            ...
            if 'Add_address'in request.POST:
                ...
                OrderMaster(
                    ...
                    courier_charges=courier_charges(customer.id)
                ).save()
                for c in cart:
                    Order_detail(
    ...
    contaxt={
        ...
        'total_amount': total_amount,
        'customer': customer,
        'total_amount_sub':total_amount_sub
    }
